...
public class CategoryUtils {
    ...
    public static Category buildCategoriesAndReturnRoot() {
        List<Category> elektronikaPodkategorie = new ArrayList<>();
        elektronikaPodkategorie.add(new Category("RTV", "url/rtv", Collections.emptyList()));


        List<Category> level1Categories = new ArrayList<>();
        level1Categories.add(new Category("Elektronika", "{url/elektronika}", elektronikaPodkategorie));
